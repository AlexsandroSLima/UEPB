    ...
    for (j=hannoi[0].top; j>=0; j--){
        if ( hannoi[0].discos[j]== 1){
         printf("   %c%c%c ",bloco, bloco, bloco);
          gotoxy(0,cord++);
        }else if( hannoi[0].discos[j]== 2){
           printf("  %c%c%c%c%c",bloco, bloco, bloco, bloco, bloco);
            gotoxy(0,cord++);
        }else if( hannoi[0].discos[j]== 3){
   ...
   gotoxy(25,cord++);
      ...
      for (j=hannoi[1].top; j>=0; j--){
        ...
        if(hannoi[1].discos[j]== 1){
          printf("   %c%c%c    ",bloco, bloco, bloco);
            gotoxy(25,cord++);
        }else if( hannoi[1].discos[j]== 2){
            printf("  %c%c%c%c%c",bloco, bloco, bloco, bloco, bloco);
              gotoxy(25,cord++);
        }else if ( hannoi[1].discos[j]== 3){
         printf(" %c%c%c%c%c%c%c ",bloco, bloco, bloco, bloco, bloco, bloco, bloco);
           gotoxy(25,++cord);
        }
      }
...
int main(void){
        system("color f0");
        int i = 0,jogadas = 0;
        int pilhaRetira = 0,pilhaInsere = 0;
