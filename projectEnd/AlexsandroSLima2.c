                ...
                switch(opcaoDigitada){
                    ...
                    case 1:
                            ...
                            if(op == 1){
                                ...
                                if(usuario == 1){
                                    congressistas=fopen("congressistas.bin","ab");
                                    for(i=0;i<quant;i++){
                                ...
                                if(usuario == 2){
                                    palestrantes=fopen("palestrantes.bin","ab");
                                    for(i=0;i<quant;i++){
                                ...
                                if(usuario == 3){
                                    organizadores=fopen("organizadores.bin","ab");
                                    for(i=0;i<quant;i++){
                    ...
                    case 2:
                            ...
                            if(op == 1){
                               ...
                               if(op ==1){
                                   congressistas=fopen("congressistas.bin","rb");
                               ...
                               if(op == 2){
                                   system("cls");
                                   palestrantes=fopen("palestrantes.bin","rb");
                               ...
                               if(op == 3){
                                   system("cls");
                                   organizadores=fopen("organizadores.bin","rb");
